	...
	<xsl:template match="/xml/rs:data/zt:row" mode="data">
		<ss:Row>
			<xsl:for-each select="current()/@*">
				...
				<xsl:variable name="type">
					<xsl:choose>
						<xsl:when test="normalize-space(/xml/st:Schema/st:ElementType/st:AttributeType[@name=$name]/st:datatype/@dt:type)='float'">
							<xsl:value-of select="'Number'"/>
						</xsl:when>
						<xsl:when test="normalize-space(/xml/st:Schema/st:ElementType/st:AttributeType[@name=$name]/st:datatype/@dt:type)='number'">
							<xsl:value-of select="'Number'"/>
						</xsl:when>
						<xsl:when test="normalize-space(/xml/st:Schema/st:ElementType/st:AttributeType[@name=$name]/st:datatype/@dt:type)='string'">
							<xsl:value-of select="'String'"/>
						</xsl:when>
						<xsl:when test="normalize-space(/xml/st:Schema/st:ElementType/st:AttributeType[@name=$name]/st:datatype/@dt:type)='dateTime'">
